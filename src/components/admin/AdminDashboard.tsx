      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500">
            System-wide performance and provider management.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => {
          ...
          return (
            <Card
              key={stat.label}
              className="rounded-2xl border-slate-100 shadow-sm hover:shadow-md transition-all group"
            >
              ...
              <CardContent>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span
                    className={`text-xs font-bold ${stat.trendUp ? "text-emerald-500" : "text-red-500"}`}
                  >
                    {stat.trend}
                  </span>
                </div>
